...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-ivy lsp-ui lsp-mode which-key org-modern-indent yaml-mode tomelr doom-modeline ox-hugo counsel-projectile projectile hydra all-the-icons-ivy-rich ivy-rich ivy-prescient counsel toc-org org-modern evil-collection evil all-the-icons dashboard poet-theme doom-themes use-package)))
(custom-set-faces
