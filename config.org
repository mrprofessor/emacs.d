...
#+begin_src emacs-lisp
  (defun my-leuven-comment-face-customization ()
    ...
    (if (string-equal (car custom-enabled-themes) "leuven-dark")
        (custom-set-faces
...
- =C-c e t= to switch themes.

  #+begin_src emacs-lisp
    (global-set-key (kbd "C-c e t") 'counsel-load-theme)
  #+end_src

- =C-c e d= to toggle debug mode

  #+begin_src emacs-lisp
    (global-set-key (kbd "C-c e d") 'eos/toggle-debug-mode)
  #+end_src

- =C-c e s= to toggle transparency

  #+begin_src emacs-lisp
    (global-set-key (kbd "C-c e s") 'toggle-transparency)
  #+end_src
