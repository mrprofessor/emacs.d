...
#+begin_src emacs-lisp
  (use-package ghostel
    :straight (:host github :repo "dakra/ghostel" :files ("*.el")))
#+end_src
...
- =eos/ghostel-toggle= to toggle a ghostty window

#+begin_src emacs-lisp
    (defun eos/ghostel-toggle ()
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c e g") 'eos/ghostel-toggle)             ;; Start a ghostty
