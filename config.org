...
- Start emacs in a fullscreen mode
  EDIT: 19/08/2024: It doesn't seem to work well with Mac tiling manager
...
#+begin_src elisp
    ...
    ;; Makes the window draggable even without the title bar
...
#+BEGIN_SRC elisp
  (use-package doom-themes
    ...
    (load-theme 'doom-oksolar-light t)   ; Load a theme
...
#+begin_src elisp
  (defvar transparency-level-active 90
    "Opacity level when Emacs is active.")

  (defvar transparency-level-inactive 90
...
*EDIT: Seems like I like the default styling of org mode more*
...
Custom function to ask for root directory.
