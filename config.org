...
Terminal emulator powered by libghostty-vt. Very new and vibe-coded though.
...
- =eos/toggle-term= to toggle a ghostty window
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c e g") 'eos/toggle-term)                ;; Start a ghostty
